<div class="mfn-main-slider" id="mfn-rev-slider">
    ...
    <rs-module-wrap id="rev_slider_2_1_wrapper" data-source="gallery" style="padding:0;margin:0px auto;margin-top:0;margin-bottom:0;max-width:">
        <rs-module id="rev_slider_2_1" style="display:none;" data-version="6.1.0">
            <rs-slides>
                <rs-slide data-key="rs-3" data-title="Slide" data-thumb="assets/img/study_mbbs_abroad/Atharv-Overseas-Web-Banner1-100x50.jpg" data-anim="ei:d;eo:d;s:600;r:0;t:fade;sl:7;">
                    <img src="assets/img/study_mbbs_abroad/Atharv-Overseas-Web-Banner1.jpg" title="Study MBBS Aboard" data-bg="p:center top;" class="rev-slidebg" data-no-retina>
                </rs-slide>
                <rs-slide data-key="rs-4" data-title="Slide" data-thumb="assets/img/study_mbbs_abroad/Atharv-Overseas-Web-Banner-100x50.jpg" data-anim="ei:d;eo:d;s:300;r:0;t:random;sl:7;">
                    <img src="assets/img/study_mbbs_abroad/Atharv-Overseas-Web-Banner.jpg" title="Study MBBS Aboard" data-bg="p:center top;" class="rev-slidebg" data-no-retina>
                </rs-slide>
            </rs-slides>
