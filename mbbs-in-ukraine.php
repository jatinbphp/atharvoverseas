...
$data = [];
$universitydata = [];
$sql = "SELECT country_section.*, country.name FROM country_section LEFT JOIN country ON country_section.country = country.id WHERE country_section.country= 10";
$result = mysqli_query($conn, $sql);
if (mysqli_num_rows($result) === 1) {
    $data = mysqli_fetch_assoc($result);

    $sql1 = "SELECT * FROM country_university WHERE country= 10";
    ...
    <div class="content_wrapper clearfix">
        <div class="sections_group">
            <div class="entry-content" itemprop="mainContentOfPage">
                ...
                <?php if(!empty($data['processing_title']) || !empty($data['processing_content'])){ ?>
                    <div class="section mcb-section   " style="padding-top:60px; padding-bottom:0px; background-color:">
                        <div class="section_wrapper mcb-section-inner">
                            <div class="wrap mcb-wrap one  valign-top clearfix" style="">
                                <div class="mcb-wrap-inner">
                                    <div class="column mcb-column one column_fancy_heading ">
                                        <div class="fancy_heading fancy_heading_icon">
                                            <h2 class="title"><?php echo $data['processing_title']; ?></h2>
                                            <div class="inside">
                                                <img class="scale-with-grid" src="https://sp-ao.shortpixel.ai/client/to_webp,q_glossy,ret_img/https://atharvoverseas.com/wp-content/uploads/2019/12/slid.png" alt="line" style="width: 41%;height: 6px;">
                                                <?php
                                                    if(!empty($data['processing_sub_title'])){
                                                ?>
                                                        <br>
                                                        <b class="itbrood"><?php echo $data['processing_sub_title']?></b>
                                                <?php
                                                    }
                                                ?>
                                            </div>
                                    ...
                                    <?php echo $data['processing_content']; ?>
                                </div>
                            </div>
                        </div>
                    </div>
