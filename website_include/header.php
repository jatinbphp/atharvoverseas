<head>
  ...
  <title>About Us – Atharv Education Mumbai</title>
  ...
  <link rel="alternate" type="application/rss+xml" title="Atharv Education Mumbai » Feed" href="https://atharvoverseas.com/feed/">
  <link rel="alternate" type="application/rss+xml" title="Atharv Education Mumbai » Comments Feed" href="https://atharvoverseas.com/comments/feed/">
  ...
  </script><script src="./About Us – Atharv Education Mumbai_files/wp-emoji-release.min.js" type="text/javascript" defer=""></script>
  <style type="text/css">
    img.wp-smiley,
    img.emoji {
  ...
  <!-- <link rel="stylesheet" id="wp-block-library-css" href="'http://' . $_SERVER['SERVER_NAME']. 'assets/about_us_style/style.min.css" type="text/css" media="all"> -->
  ...
  <link rel="stylesheet" id="ls-google-fonts-css" href="../About Us – Atharv Education Mumbai_files/css" type="text/css" media="all">
  ...
  <link rel="stylesheet" id="wpos-slick-style-css" href="assets/css/slick.css" type="text/css" media="all">
  <link rel="stylesheet" id="iscwp-public-css-css" href="assets/css/iscwp-public.css" type="text/css" media="all">
  ...
  <link rel="stylesheet" id="mfn-layout-css" href="assets/css/layout.css" type="text/css" media="all">
  <link rel="stylesheet" id="mfn-shortcodes-css" href="assets/css/shortcodes.css" type="text/css" media="all">
  <link rel="stylesheet" id="mfn-animations-css" href="assets/css/animations.min.css" type="text/css" media="all">
  <link rel="stylesheet" id="mfn-jquery-ui-css" href="assets/css/jquery.ui.all.css" type="text/css" media="all">
  <link rel="stylesheet" id="mfn-prettyPhoto-css" href="assets/css/prettyPhoto.css" type="text/css" media="all">
  <link rel="stylesheet" id="mfn-jplayer-css" href="assets/css/jplayer.blue.monday.css" type="text/css" media="all">
  <link rel="stylesheet" id="mfn-responsive-css" href="assets/css/responsive.css" type="text/css" media="all">
  <link rel="stylesheet" id="Roboto-css" href="assets/css/css(1)" type="text/css" media="all">
  <link rel="stylesheet" id="Patua+One-css" href="assets/css/css(2)" type="text/css" media="all">
  <link rel="stylesheet" id="mystickyelements-google-fonts-css" href="./About Us – Atharv Education Mumbai_files/css(3)" type="text/css" media="all">
  <link rel="stylesheet" id="font-awesome-css-css" href="assets/css/font-awesome.min(1).css" type="text/css" media="all">
  <link rel="stylesheet" id="mystickyelements-front-css-css" href="/mystickyelements-front.min.css" type="text/css" media="all">
  <script type="text/javascript" src="./About Us – Atharv Education Mumbai_files/greensock.js" id="greensock-js"></script>
  <script type="text/javascript" src="./About Us – Atharv Education Mumbai_files/jquery.min.js" id="jquery-core-js"></script>
  <script type="text/javascript" src="./About Us – Atharv Education Mumbai_files/jquery-migrate.min.js" id="jquery-migrate-js"></script>
  <script type="text/javascript" id="layerslider-js-extra">
    /* <![CDATA[ */
    var LS_Meta = {"v":"5.6.9"};
    /* ]]> */
  </script>
  <script type="text/javascript" src="./About Us – Atharv Education Mumbai_files/layerslider.kreaturamedia.jquery.js" id="layerslider-js"></script>
  <script type="text/javascript" src="./About Us – Atharv Education Mumbai_files/layerslider.transitions.js" id="layerslider-transitions-js"></script>
  <script type="text/javascript" src="./About Us – Atharv Education Mumbai_files/revolution.tools.min.js" id="tp-tools-js"></script>
  <script type="text/javascript" src="./About Us – Atharv Education Mumbai_files/rs6.min.js" id="revmin-js"></script>
  <meta name="generator" content="Powered by LayerSlider 5.6.9 - Multi-Purpose, Responsive, Parallax, Mobile-Friendly Slider Plugin for WordPress.">
  <link rel="https://api.w.org/" href="https://atharvoverseas.com/wp-json/">
  <link rel="alternate" type="application/json" href="https://atharvoverseas.com/wp-json/wp/v2/pages/3069">
  ...
  <style id="mfn-dnmc-theme-css">
    ...
    background: linear-gradient(135deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 30%, rgba(254,204,54,1) 30%, rgba(254,204,54,1) 100%);
    }
    ...
    position: relative;
    margin: 0 auto 15px;
    background: linear-gradient(135deg,#a27979 0%,#000 100%);
    border-width: 2px;
    border-style: solid;
    ...
    background: linear-gradient(135deg,#ff2e31 0%,#da2427 100%);
    border: 0px solid #01102f9e;
    border-radius: 5px;
    }
    .plan-header h2 {
    color: white;
    ...
    {
    .wrap.mcb-wrap.one-second.dmce.valign-top.clearfix {
    border-radius: 57px 11px 0px 13px !important;
    margin-top: 33px !important;
    }
    .wrap.mcb-wrap.one-second.dmp.valign-top.clearfix {
    border-radius: 55px 8px 16px 0px !important;
    }
    ...
    border-color: rgba(202, 195, 195, 0.99);
    color: white;
    }
    .red_title{
    color:red;
    ...
    background-color: rgba(157, 155, 155, 0.7)!important;
    border-radius: 136px;
    height: 44px;
    margin-top: 54px;
    }
    .blog_slider.flat .blog_slider_header a:hover.button.slider_prev, .blog_slider.flat .blog_slider_header a:hover.button.slider_next {
    background-color: rgba(190, 83, 83, 0.7)!important;
    border-radius: 136px;
    height: 45px;
    margin-top: 54px;
    }
    ...
    .wrap.mcb-wrap.one-second.dmce.valign-top.clearfix {
    background-image: linear-gradient(#b9c9e8, #83ba55);
    padding: 39px 27px 0px;
    border: 2px Solid #d7dae0;
    border-radius: 9px 190px 0px 13px;
    box-shadow: 10px 10px 5px #8080807d;
    margin-bottom: 40px;
    margin-left: 0px;
    }
    .wrap.mcb-wrap.one-second.dmp.valign-top.clearfix {
    ...
    border: 2px Solid #d7dae0;
    border-radius: 194px 8px 16px 0px;
    box-shadow: -6px 10px 5px #8080807d;
    }
    .co{
    border: 2px solid #f8f8f8 !important;
    }
    #text-21 li:nth-child(11)  a{
    color: #01102f !important;
    font-size: 2px !important;
    cursor: unset;
    }
    #text-21 li:nth-child(12)  a{
    color: #01102f !important;
    font-size: 2px !important;
    cursor: unset;
    }
    #text-21 li:nth-child(13)  a{
    color: #01102f !important;
    font-size: 2px !important;
    cursor: unset;
    }
    #text-21 li:nth-child(11)  {
    height: 5px;
    }
    #text-21 li:nth-child(12)  {
    height: 5px;
    }
    #text-21 li:nth-child(13)  {
    height: 5px;
    }
    .pricing-box .plan-header hr{
    background: white;
    }
    .plan-footer .button.button_theme.button_js {
    background-color: black !important;
    }
    .plan-footer .button_label {
  ...
  <style type="text/css" id="wp-custom-css">
    ...
    #contact-page-div-mahi .wrap.mcb-wrap.one-fourth.co.valign-top.clearfix{
    height: 420px;
    padding: 20px 20px 10px 20px;
    position: relative;
    }
    #contact-page-div-mahi .wrap.mcb-wrap.one-fourth.co.valign-top.clearfix input{
    position: absolute;
    bottom: 10px;
    left: 50%;
    ...
    font-size: 17px;
    font-weight: bold;
    color: #f6c635 !important;
    }		
  </style>
  <noscript>
    <style type="text/css"> .wpb_animate_when_almost_visible { opacity: 1; }</style>
  </noscript>
  <link rel="stylesheet" href="./About Us – Atharv Education Mumbai_files/font-awesome.min(2).css">
  <script async="" src="./About Us – Atharv Education Mumbai_files/js"></script>
  <script>
  ...
  <script async="" src="./About Us – Atharv Education Mumbai_files/js(1)"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());
  ...
  <meta http-equiv="origin-trial" content="">
  <script type="text/javascript" async="" src="./About Us – Atharv Education Mumbai_files/f.txt"></script><script attributionsrc="" type="text/javascript" async="" src="./About Us – Atharv Education Mumbai_files/f(1).txt"></script>
</head>