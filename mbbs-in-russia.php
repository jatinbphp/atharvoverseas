...
$data = [];
$universitydata = [];
$sql = "SELECT country_section.*, country.name FROM country_section LEFT JOIN country ON country_section.country = country.id WHERE country_section.country= 8";
$result = mysqli_query($conn, $sql);
if (mysqli_num_rows($result) === 1) {
    $data = mysqli_fetch_assoc($result);

    $sql1 = "SELECT * FROM country_university WHERE country= 8";
